...
const CardObat2 = ({ image, diskon, title, hargaasli, hargadiskon, cardClass, kegunaan, onClick, disabled }) => {
    return (
        <div onClick={!disabled ? onClick : undefined} className={`bg-slate-300 rounded-lg w-[160px] h-[220px] lg:max-w-[720px] border border-gray-400 ${cardClass} flex flex-col justify-between`}>
            ...
            <div className='bg-diskon m-3 w-[70px] h-[20px] text-center rounded-xl absolute mt-2 ml-1'>
                <h2 className='text-[12px] p-0 text-center text-white font-poppins'> {diskon}%</h2>
            </div>
            <div className='w-full items-center justify-center flex'>
                <div className="w-full h-[75px] justify-center rounded-lg m-[5px] mt-4 flex items-center bg-white ">
                    <img src={image} alt=""
