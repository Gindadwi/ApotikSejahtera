...
const CheckoutPage = () => {
    ...
    const handlePlaceOrder = async () => {
        ...
        // Periksa apakah semua detail pengiriman sudah diisi
        if (!orderDetails.nama || !orderDetails.nomor || !orderDetails.alamat) {
        ...
        try {
            ...
            window.snap.pay(snapToken, {
                onSuccess: async function (result) {
                    ...
                    try {
                        ...
                        await axios.post(
                            'https://simple-notes-firebase-8e9dd-default-rtdb.firebaseio.com/orders.json',
                            {
                                ...order,
            ...
            alert('Terjadi kesalahan dalam proses transaksi. Silakan coba lagi.');
        }
    };
    const { snapToken } = response.data;
